#===-- Kernel-GNU-C-x86.cmake - CMake System-Compiler-Language-Architecture File ====-------------------*- CMake -*-===#
#
...
IF (TREE_SELF_PATH) # This will define if we have access to the scope variables and cache
 ...
 STRING(APPEND CMAKE_C_FLAGS_INIT "-mabi=sysv ")
 STRING(APPEND CMAKE_C_FLAGS_INIT "-mfpmath=sse ")
 STRING(APPEND CMAKE_C_FLAGS_INIT "-msse2 ")
