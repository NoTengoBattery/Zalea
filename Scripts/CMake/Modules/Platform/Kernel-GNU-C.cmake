#===-- Kernel-GNU-C.cmake - CMake System-Compiler-Language File ====------------------------------------*- CMake -*-===#
#
...
IF (TREE_SELF_PATH) # This will define if we have access to the scope variables and cache
  ...
  STRING(APPEND CMAKE_C_FLAGS_INIT "-fstack-protector-strong -fstack-clash-protection ")
  STRING(APPEND CMAKE_C_FLAGS_INIT "-fsanitize=kernel-address ")
