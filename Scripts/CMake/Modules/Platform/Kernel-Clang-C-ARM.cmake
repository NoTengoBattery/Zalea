#===-- Kernel-Clang-C-ARM.cmake - CMake System-Compiler-Language-Architecture file ====-----------------*- CMake -*-===#
#
...
IF (TREE_SELF_PATH) # This will define if we have access to the scope variables and cache
  ...
  STRING(APPEND CMAKE_C_FLAGS_INIT "-mfloat-abi=soft ")
  STRING(APPEND CMAKE_C_FLAGS_INIT "-mtp=soft ")

  # These flags are based on which kind of build we are doing
  STRING(APPEND CMAKE_C_FLAGS_DEBUG_INIT "-marm ")
  STRING(APPEND CMAKE_C_FLAGS_MINSIZEREL_INIT "-mthumb ")
  STRING(APPEND CMAKE_C_FLAGS_RELEASE_INIT "-mthumb ")
  STRING(APPEND CMAKE_C_FLAGS_RELWITHDEBINFO_INIT "-marm ")
