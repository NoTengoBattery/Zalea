...
#define _ALIGN_COMMONPAGE ALIGN ( CONSTANT ( COMMONPAGESIZE ) )
#define _ALIGN_MINI ALIGN ( MINI_ALIGN )
...
#define _ASSERT_LOAD_ADDRESS _ASSERT_ADDRESS(MACHINE_LOAD_ADDRESS, _ALIGN_COMMONPAGE)
#define _ASSERT_VIRTUAL_ADDRESS _ASSERT_ADDRESS(MACHINE_VIRTUAL_ADDRESS, _ALIGN_COMMONPAGE)
#define _ASSERT_STACK_SIZE _ASSERT_ADDRESS(MACHINE_STACK_SIZE, _ALIGN_COMMONPAGE)
#define _SEGMENTSTART(x) . = SEGMENT_START ( x , MACHINE_VIRTUAL_ADDRESS );
#define _ALIGNED_CPS_SEGMENTSTART(x) . = SEGMENT_START ( x , _ALIGN_COMMONPAGE );
#else
