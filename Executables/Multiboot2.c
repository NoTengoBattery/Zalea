...
const struct multibootHeaderTag multibootHeader MULTIBOOT_ATTR = {
        ...
        (const uint32_t) MULTIBOOT_HEADER_CHECKSUM
};
...
const struct multibootAddressTag multibootAddress MULTIBOOT_ATTR = {
        ...
        (const uint32_t) MULTIBOOT_HEADER_TAG_ADDRESS_HEADER_ADDRESS,
        (const uint32_t) MULTIBOOT_HEADER_TAG_ADDRESS_LOAD_ADDRESS,
        (const uint32_t) MULTIBOOT_HEADER_TAG_ADDRESS_LOAD_END_ADDRESS,
        (const uint32_t) MULTIBOOT_HEADER_TAG_ADDRESS_BSS_END_ADDRESS
};
...
const struct multibootEntryAddressTag multibootEntryAddress MULTIBOOT_ATTR = {
        ...
        (const uint32_t) MULTIBOOT_HEADER_TAG_ENTRY_ADDRESS_ENTRY_ADDRESS
};
